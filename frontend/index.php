    ...
    <div class="page-content">
      <div class="header">
        <div class="logo" href="/index.php" aria-label="Home" accesskey="1">
          <img src=https://www.clipartmax.com/png/middle/142-1429905_happy-filly-applejack-by-coldbolognamy-little-pony-princess-candies-my-little-pony.png" width="20" height="20" alt="home">
        </div>
        <div class="nav-bar">
          <div class="dropmenu">
